...
namespace Sander0542.UnraidAPI.Types
{
    public class Partition
    {
        ...
        [JsonPropertyName("idFsType")]
        public string IdFsType { get; set; }

        [JsonPropertyName("idFsUsage")]
        public string IdFsUsage { get; set; }

        [JsonPropertyName("idFsUuid")]
        public string IdFsUuid { get; set; }

        [JsonPropertyName("idFsUuidEnc")]
        public string IdFsUuidEnc { get; set; }
        ...
        [JsonPropertyName("idPartEntryDisk")]
        public string IdPartEntryDisk { get; set; }

        [JsonPropertyName("idPartEntryNumber")]
        public string IdPartEntryNumber { get; set; }

        [JsonPropertyName("idPartEntryOffset")]
        public string IdPartEntryOffset { get; set; }

        [JsonPropertyName("idPartEntryScheme")]
        public string IdPartEntryScheme { get; set; }

        [JsonPropertyName("idPartEntrySize")]
        public string IdPartEntrySize { get; set; }

        [JsonPropertyName("idPartEntryType")]
        public string IdPartEntryType { get; set; }
